package com.fantaike.emailmanagerkt.send.component;
...
public class RichEditor extends WebView {
    ...
    public static void setValueChanged(RichEditor view, InverseBindingListener listener) {
        view.setOnTextChangeListener(new OnTextChangeListener() {
            @Override
